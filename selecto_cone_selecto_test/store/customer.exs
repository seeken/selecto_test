...
# - Payment (Base Layer)
#
# Usage: mix run selecto_cone_selecto_test/store/customer.exs
...
Application.put_env(:selecto_cone, SelectoCone.Endpoint,
  ...
  server: true,
  render_errors: [
    formats: [html: SelectoCone.ErrorHTML, json: SelectoCone.ErrorJSON],
    layout: false
  ],
...
defmodule SelectoCone.ErrorHTML do
  use Phoenix.Component
...
defmodule SelectoCone.ErrorJSON do
...
📍 Visit: http://localhost:4090/selecto_cone
