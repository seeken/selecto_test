defmodule SelectoTest.MixProject do
  ...
  defp selecto_dep do
    if use_local_ecosystem?() do
      ...
      {:selecto,
       github: "seeken/selecto", ref: "0c7589592a5db10fdb130e12dd2abac2fc89b615", override: true}
    end
  end
  ...
  defp selecto_postgis_dep do
    if use_local_ecosystem?() do
      ...
      {:selecto_postgis,
       ...
       ref: "3b735ddaba1c21dfea600e18e1624f37a973b519",
       override: true}
    end
  end
  ...
  defp selecto_mix_dep do
    if use_local_ecosystem?() do
      ...
      {:selecto_mix,
       ...
       ref: "34fc29a407a142ee7eeb6dea4420524e022f0f99",
       only: [:dev, :test]}
    end
  end
