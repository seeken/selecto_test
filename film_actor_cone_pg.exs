...
# Import schema modules - using full module paths
defmodule FilmCone.ConeLive do
  ...
  # Alias the schema modules for easier access
  alias SelectoTest.Store.Film
  alias SelectoTest.Store.Actor
  alias SelectoTest.Store.FilmActor
...
# Phoenix Playground handles all the boilerplate!
